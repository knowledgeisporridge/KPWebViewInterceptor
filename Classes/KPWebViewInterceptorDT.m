...
- (id)initWithMessageName:(NSString *)name {
    if ( self = [super init] ) {
		// Daniel T: Should make a copy of the string, as it could be a mutable string. 
		// Also want to make sure we retain a reference. :)
...
// Daniel T: Need to release all the retained, was a memory leak here.
- (void)dealloc {
